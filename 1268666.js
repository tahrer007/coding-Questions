 ...
 */
 ...
 const suggestedProducts = function (products, searchWord) {
   ...
   for (let i=0 ; i <str.length ; i++){
     ...
     let arr = sortedArr.filter(x => x.replace(/\s/g, '').includes(temp));//filltered 
     sortedArr=arr; 
     (arr.length>3)?finalResult.push(arr.slice(0,3)) :finalResult.push(arr);
